...
export default function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#41B3C4]/80">
        {projects?.map((project, i) => (
          ...
          >
            ...
            <div className="space-y-3 md:space-y-5 px-0 md:px-10 max-w-6xl">
              <h4 className="text-lg md:text-2xl lg:text-2xl font-semibold text-center">
                <span className="underline decoration-[#41B3C4]/50">
                  Project {i + 1}:
                </span>{" "}
                {project?.title}
              </h4>
      ...
      <div className="w-full absolute top-[30%] bg-[#41B3C4]/20 left-0 h-[300px] -skew-y-12"></div>
    </motion.div>
  );
}
